...
public class ModelSwordfish extends ModelBase {
    ...
    public ModelSwordfish() {
        ...
        this.fin_tail.setRotationPoint(0.0F, 0.0F, 9.0F);
        this.fin_tail.addBox(-0.5F, -4.0F, 0.0F, 1, 8, 3, 0.0F);
        this.fin_right = new ModelRenderer(this, 45, 0);
        this.fin_right.setRotationPoint(-1.0F, 2.5F, -3.0F);
        ...
        this.fin_top.setRotationPoint(0.0F, 0.0F, 0.0F);
        ...
        this.fin_left.setRotationPoint(1.0F, 2.5F, -3.0F);
        ...
        this.sword.setRotationPoint(0.0F, 0.0F, 0.0F);
